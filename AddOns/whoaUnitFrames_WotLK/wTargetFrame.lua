...
function whoaTargetFrames (self, forceNormalTexture)
	...
	self.healthbar.RightText:SetPoint("RIGHT", self.healthbar, "RIGHT", -6, 0);
	...
	self.manabar.RightText:SetPoint("RIGHT", self.manabar, "RIGHT", -6, 0);
	...
	if ( cfg.whoaTexture == true) then
		self.healthbar:SetStatusBarTexture("Interface\\Addons\\whoaUnitFrames_WotLK\\media\\statusbar\\"..cfg.SBTextureName);
	end
end

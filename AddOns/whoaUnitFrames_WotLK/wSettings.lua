whoa = {}
cfg = {}
whoaAddon = "whoaUnitFrames_WotLK";
...
function darkFramesDo(self)
	local path = cfg.frameMode;
	PlayerFrameAlternateManaBarBorder:SetTexture("Interface\\Addons\\"..whoaAddon.."\\media\\"..path.."\\numeric");
...
local function fontStyleDo()
	...
	for i, v in pairs({	PlayerFrameHealthBarText, PlayerFrameHealthBarTextLeft,	PlayerFrameHealthBarTextRight,
		...
		PetFrameHealthBarTextRight, PetFrameManaBarText, PetFrameManaBarTextLeft, PetFrameManaBarTextRight, PlayerFrameAlternateManaBarText, }) do 
